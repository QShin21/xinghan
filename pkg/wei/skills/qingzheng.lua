...
Fk:loadTranslationTable {
  ["xh__qingzheng"] = "清正",
  [":xh__qingzheng"] = "出牌阶段开始时，你可以展示所有手牌并弃置其中一种花色的所有牌，"..
    "然后展示一名其他角色的所有手牌并弃置其中一种花色的所有牌，"..
    "若你以此法被弃置的牌数大于其以此法被弃置的牌数，你对其造成1点伤害。",

  ["#xh__qingzheng-invoke"] = "清正：展示手牌，弃置一种花色的牌，令其他角色弃置同花色牌",
  ["#xh__qingzheng-suit"] = "清正：选择要弃置的花色",
  ["#xh__qingzheng-target"] = "清正：选择一名其他角色",

  ["$xh__qingzheng1"] = "清正廉明，公正无私！",
  ["$xh__qingzheng2"] = "正大光明，何惧之有！",
}
