...
Fk:loadTranslationTable {
  ["yuanhu"] = "援护",
  [":yuanhu"] = "出牌阶段限一次，你可以将一张装备牌置入一名角色的装备区里，然后若此牌为：武器牌，你弃置其距离为1的另一名角色区域里的至多两张牌；防具牌，其摸两张牌；坐骑牌，其回复1点体力。",

  ["#yuanhu-choose"] = "援护：选择一张装备牌和一名角色",
  ["#yuanhu-discard"] = "援护：弃置 %dest 距离1的角色区域里的至多两张牌",
  ["#yuanhu-discard2"] = "援护：选择要弃置的牌（至多2张）",
